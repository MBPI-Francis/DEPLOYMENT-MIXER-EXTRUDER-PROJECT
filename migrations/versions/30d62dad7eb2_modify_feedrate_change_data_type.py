"""modify: feedrate change data type

Revision ID: 30d62dad7eb2
Revises: 8c698bc77281
Create Date: 2025-11-25 13:31:58.417752
...
revision: str = '30d62dad7eb2'
down_revision: Union[str, Sequence[str], None] = '8c698bc77281'
...
def upgrade() -> None:
    ...
    op.alter_column('tbl_extruder_old_excel_data', 'feed_rate',
