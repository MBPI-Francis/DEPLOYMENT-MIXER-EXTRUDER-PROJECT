...
from .benchmark_report.main import ExtruderBenchmarkReportView
from .production_report.main import ExtruderProductionView
...
class ExtruderReportView(QWidget):
    ...
    def __init__(self, session_factory: Type[sessionmaker], parent=None):
        ...
        self.extruder_production_report = ExtruderProductionView(session_factory=self.Session)
        self.extruder_benchmark_report = ExtruderBenchmarkReportView(session_factory=self.Session)
        ...
        self.extruder_production_report.setObjectName("scroll_content_widget")

        # Place the entry form *inside* the scroll area.
        entry_form_scroll_area.setWidget(self.extruder_production_report)
        ...
        self.tab_widget.addTab(self.extruder_benchmark_report, "Benchmark Report")
        self.tab_widget.addTab(entry_form_scroll_area, "Production Report")