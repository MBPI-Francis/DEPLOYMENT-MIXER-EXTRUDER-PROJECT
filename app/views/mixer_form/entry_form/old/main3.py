...
from PyQt6.QtWidgets import (
    ...
    QSpinBox, QDoubleSpinBox, QTextEdit, QComboBox, QScrollArea, QFrame, QSizePolicy, QSpacerItem
)
...
class MixerFormView(QWidget):
    """
    The main view for the Mixer Form, featuring a dynamic list of form rows.
    """
    ...
    def _setup_ui(self):
        ...
        # The ScrollArea now contains EVERYTHING, making the whole page scrollable.
        scroll_area = QScrollArea()
        scroll_area.setWidgetResizable(True)
        main_layout.addWidget(scroll_area)

        # A single container widget holds all other UI elements.
        content_widget = QWidget()
        content_widget.setObjectName("ScrollContainerWidget")
        scroll_area.setWidget(content_widget)
        content_layout = QVBoxLayout(content_widget)

        # --- Header Section (No QGroupBox) ---
        ...
        # Add a spacer to push header items to the left
        header_layout.addItem(QSpacerItem(20, 40, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum), 0, 4)
        ...
        # --- Assemble Final Layout into the Scroll Area's content ---
        ...
        content_layout.addWidget(staged_group)
        content_layout.addLayout(final_actions_layout)
