...
class DetailRowWidget(QWidget):
    ...
    def __init__(self, machine_map: dict, detail=None):
        ...
        # Assign an objectName for CSS styling
        ...
        # --- IMPROVED: Group time fields for better layout management ---
        ...
        # --- Use stretch factors that match the header for perfect alignment ---
...
# --- 1. Header Section ---
        # We use a QGridLayout for precise control over the alignment and spacing of header fields.
        header_layout = QGridLayout()
        # Set column spacing for gaps between groups, but row spacing to 0 for tight label-field pairing.
        ...
        # Create a dedicated horizontal layout for the time inputs for a cleaner look
        time_layout = QHBoxLayout()
        time_layout.setContentsMargins(0,0,0,0)
        time_layout.setSpacing(5) # Keep the time inputs close to the "to" label
        time_layout.addWidget(self.time_start_input)
        time_layout.addWidget(QLabel("to"))
        time_layout.addWidget(self.time_end_input)

        # --- Add widgets to the grid layout at specific positions (row, column) ---
        # Group 1: Reference Number
        ...
        # This spacer is the key to responsiveness. It takes up all extra horizontal space,
        # keeping the input field groups neatly packed on the left.
    ...
    def _handle_save_draft(self):
        ...
        try:
            ...
            # --- NEW: Check if there are any details to save ---
            if not details_data:
