...
#
#         # --- MODIFIED: Flexible Time Range Filters ---
#         # This logic now correctly handles receiving only a "from" or only a "to" time.
#         if filters.get("proc_time_from"):
#             conditions.append(md.process_time_start >= filters["proc_time_from"])
#         if filters.get("proc_time_to"):
#             conditions.append(md.process_time_end <= filters["proc_time_to"])
#         if filters.get("clean_time_from"):
#             conditions.append(md.cleaning_time_start >= filters["clean_time_from"])
#         if filters.get("clean_time_to"):
#             conditions.append(md.cleaning_time_end <= filters["clean_time_to"])
#
