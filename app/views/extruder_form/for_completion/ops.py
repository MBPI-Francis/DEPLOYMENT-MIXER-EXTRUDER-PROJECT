...
class ExtruderRecordsOperations:
    ...
    def _apply_filters(self, query, filters):
        ...
        # --- NEW FIX: Filter by completion status if provided ---
        if 'is_completed' in filters:
            query = query.filter(ExtruderFormData.is_completed == filters['is_completed'])
        # --- END NEW FIX ---
        ...
        return query# app/views/extruder_form/records/ops.py
