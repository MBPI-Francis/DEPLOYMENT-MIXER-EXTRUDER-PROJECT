...
from PyQt6.QtWidgets import (
    ...
    QTimeEdit, QDateEdit, QSpacerItem, QSizePolicy
)
...
class Ui_ExtruderEntryForm:
    def setup_ui(self, parent_widget: QWidget):
        ...
        order_group = self._create_order_operator_group()
    ...
    def _create_order_operator_group(self):
        group = QGroupBox("Order and Operator Information")
        ...
        # --- FIX: Using the reverted label "Qty. Produced (kg)" ---
        ...
        self.operators_table = QTableWidget(0, 2)
        self.operators_table.setHorizontalHeaderLabels(["Name", "Position"])
        ...
        self.remove_operator_btn = QPushButton("Remove Selected")
        op_button_layout.addWidget(self.add_operator_btn)
        op_button_layout.addWidget(self.remove_operator_btn)
        layout.addLayout(op_button_layout)
        return group
