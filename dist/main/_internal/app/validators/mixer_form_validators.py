...
# app/validators/mixer_form_validators.py
import re
from datetime import date, time
from typing import List, Optional
from pydantic import BaseModel, Field, conint, confloat, validator, field_validator
...
class MixerDetailCreateValidator(BaseModel):
    ...
    cleaning_time_start: Optional[str]
    cleaning_time_end: Optional[str]
    cleaning_rm_code: Optional[str] = Field(max_length=30)
    cleaning_qty: Optional[float]
