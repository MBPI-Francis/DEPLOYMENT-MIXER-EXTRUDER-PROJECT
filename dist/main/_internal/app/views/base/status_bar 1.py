...
#         self.root.db_status_icon_label.setObjectName("Dashboard-db-status-icon-label")
#
#         self.root.db_status_text_label = QLabel()
#         self.root.db_status_text_label.setObjectName("Dashboard-db-status-text-label")
#
#         self.root.time_label = QLabel()
#         self.root.time_label.setObjectName("Dashboard-status-time-label")
#
#         self.root.powered_by_software = QLabel("Powered by PYQT6")
...
#
#         self.root.status_bar.addPermanentWidget(self.root.powered_by_software)
#         self.root.status_bar.addPermanentWidget(self.root.create_separator())
#
...
#                                             ))
#         self.root.status_timer.setObjectName("Dashboard-status-qtimer")
#
