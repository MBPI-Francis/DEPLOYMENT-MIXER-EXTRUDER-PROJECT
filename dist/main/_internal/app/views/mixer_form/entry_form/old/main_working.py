...
class DetailRowWidget(QWidget):
    ...
    def __init__(self, machine_map: dict, detail=None):
        ...
        # --- MODIFIED: `clean_rm_code_edit` is now a SmartComboBox ---
...
class MixerFormView(QWidget):
    ...
    def _load_initial_data(self):
        ...
        try:
            ...
            self.initial_lot_numbers = get_initial_lot_numbers(session, limit=1000)
            print("Fetching initial product codes...")
            self.initial_product_codes = get_initial_product_codes(session, limit=1000)

            print("Fetching initial raw materials...")
            self.initial_raw_materials = get_initial_raw_materials(session, limit=1000)
    ...
    def _add_row_widget(self, detail=None):
        ...
        # Populate with the initial, fast lists
        ...
        # --- CONNECT THE LIVE SEARCH SIGNALS ---
